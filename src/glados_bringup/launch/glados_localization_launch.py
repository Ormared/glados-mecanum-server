...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('glados_bringup')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value='/workspaces/glados-mecanum-server_AO/src/glados_bringup/maps/map_save.yaml', description='Full path to map yaml file to load'
    )
